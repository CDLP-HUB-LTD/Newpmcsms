    ...
    return Stack(
      ...
      children: [
        ...
        ValueListenableBuilder<
          ...
          valueListenable: widget.controller._valueNotifier,
          builder: (context, listen, child) {
            // ✅ FIXED: none state is fully invisible and non-blocking
            if (listen.type == OverLayType.none) {
            ...
            if (listen.type == OverLayType.message) {
              return IgnorePointer(
                // ✅ message banner doesn't block taps below it
                ignoring: true,
                child: SafeArea(
                  child: Container(
                    padding: widget.messagePadding ?? const EdgeInsets.all(20),
            ...
            if (listen.type == OverLayType.toast) {
              return IgnorePointer(
                // ✅ toast doesn't block taps below it
                ignoring: true,
                child: SafeArea(
                  child: Container(
                    padding: widget.messagePadding ?? const EdgeInsets.all(20),
