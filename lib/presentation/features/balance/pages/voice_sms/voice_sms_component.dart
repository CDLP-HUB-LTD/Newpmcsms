...
class VoiceSmsComponent extends ConsumerStatefulWidget {
  const VoiceSmsComponent({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _VoiceSmsComponentState();
}

class _VoiceSmsComponentState extends ConsumerState<VoiceSmsComponent> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    final voiceSmsBalance = ref.watch(getWalletBalanceNotifier.select((v) {
      final balanceList = v.getBalanceResponse?.data?.balance
          ?.where((e) => e.name?.toLowerCase() == 'voice sms balance')
          .map((e) => e.value)
          .toSet()
          .toList();
              ...
              children: [
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      SvgPicture.asset('assets/icons/voice_sms.svg'),
                ...
                Row(
                  ...
                  children: [
                    Text(
                      '${hideBalance ? '****' : voiceSmsBalance} Units',
